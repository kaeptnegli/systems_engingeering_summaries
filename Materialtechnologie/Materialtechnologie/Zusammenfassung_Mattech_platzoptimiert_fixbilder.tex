\documentclass[8.5pt,twocolumn]{extarticle}

\usepackage[utf8]{inputenc}
\usepackage[T1]{fontenc}
\usepackage[english]{babel}
\usepackage[a4paper,left=0.4cm,right=0.4cm,top=0.45cm,bottom=0.45cm]{geometry}
...
\usepackage{microtype} % better kerning/protrusion -> fewer line breaks
\usepackage{etoolbox}
\usepackage{tabularx}

\pretocmd{\textbf}{\small}{}{}

% --- space saving (still readable) ---
\setlength{\parindent}{0pt}
\setlength{\parskip}{0pt}

% tighter two-column gap
\setlength{\columnsep}{0.3cm}

% tighter math display spacing
...
\titlespacing*{\section}{0pt}{*0.6}{*0.2}
\titlespacing*{\subsection}{0pt}{*0.5}{*0.15}
\titlespacing*{\subsubsection}{0pt}{*0.45}{*0.1}
\titlespacing*{\paragraph}{0pt}{0.25ex}{0.4em}
...
\begin{document}
    ...
    \begin{minipage}[t]{0.45\columnwidth}
        \begin{itemize}[label={}, leftmargin=*,  itemsep=0.1em]
            ...
            \item Dehnung: \\ $\epsilon = \frac{\Delta l}{l_0}\qquad[\epsilon]=-$
    ...
    \begin{minipage}[t]{0.55\columnwidth}
        \begin{itemize}[label={}, leftmargin=*,  itemsep=0.1em]
            ...
            \item Scherung: \\ $\gamma = tan\alpha = \frac{\Delta y}{h} \qquad[\gamma]=-$
...
\par\noindent
\subsection{Kerbschalgbiegeversuch}
    ...
    \subsection{Wirbelstromprüfung}
    \subsection{Magnetpulverprüfung}
    ...
    \subsection{Farbeindringprüfung PT(Penetrant Test)}
    ...
    \end{itemize}
    \subsection{Replika-Methode}
    \subsection{Mechanische Eigenschaften}
    \textbf{Steifigkeit:} elast. Widerstand; $\sim E$ (Steigung SD).
    \textbf{Härte:} Eindringwiderstand.
    \textbf{Zähigkeit:} Energie bis Bruch; $\sim$ Fläche SD-Kurve.
    \textbf{Festigkeit:} Widerstand gg.\ plast. Verformung/Bruch;
    Zug/Druck/Biege/Scher/Knick/Torsion.
    \section*{Aufau von Metallen}
    \subsection{Gittertypen}\mbox{}\\
    \begin{minipage}[t]{0.32\columnwidth}
        \begin{itemize}[label={}, leftmargin=*,  itemsep=0.01em]
            \item \textbf{kfz}
            \item[]\centering \includegraphics[width=0.9\linewidth]{img/kfz.png}
    ...
    \begin{minipage}[t]{0.32\columnwidth}
        \begin{itemize}[label={}, leftmargin=*,  itemsep=0.01em]
            \item \textbf{krz}
            \item[]\centering \includegraphics[width=0.9\linewidth]{img/krz.png}
    ...
    \begin{minipage}[t]{0.32\columnwidth}
        \begin{itemize}[label={}, leftmargin=*,  itemsep=0.01em]
            \item \textbf{hdp}
            \item[]\centering \includegraphics[width=0.9\linewidth]{img/hdp.png}
            \item GE: 1 \\ GR: 3 \\ GS: 3
        \end{itemize}
    \end{minipage}\hfill
    \subsection{Phase} Bereich konstanter Struktur und chemischer
    Zusammensetzung.
    ...
    \begin{minipage}[t]{0.5\columnwidth}
        \begin{itemize}[label={}, leftmargin=*, itemsep=0.01em]
            ...
            \item Zwillingsgrenze \\ Stapelfehler \\ Kleinwinkelkorngrenze \\ Grosswinkelkorngrenze $\alpha>15°$
        \end{itemize}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.5\columnwidth}
        \begin{itemize}[label={}, leftmargin=*,  itemsep=0.01em]
    ...
    \end{minipage}\hfill
    \section*{Legierungen}
    \subsection{Vollständige Lösbarkeit (Mischkristall)}
    \begin{itemize}[label={}, leftmargin=*,  itemsep=0.01em]
    ...
    \end{itemize}
    \subsection{Vollständige Unlösbarkeit (Kristallgemischlegierung)}
    \begin{itemize}[label={}, leftmargin=*,  itemsep=0.01em]
    ...
    \end{itemize}
    \subsection{Teilweise Lösbarkeit (Gemisch aus Mischkristall)}
    ...
    \subsection{Einteilung nach Verwendungszweck}
    \begin{minipage}[t]{0.5\columnwidth}
        \begin{itemize}[label={}, leftmargin=*, itemsep=0.01em]
    ...
    \begin{minipage}[t]{0.5\columnwidth}
        ...
        \end{itemize} 
    \end{minipage}\hfill
    \subsection{Einteilung nach metallphysikalischen Merkmalen}
    \begin{minipage}[t]{0.5\columnwidth}
        \begin{itemize}[label={}, leftmargin=*, itemsep=0.01em]
    ...
    \begin{minipage}[t]{0.5\columnwidth}
        ...
        \end{itemize} 
    \end{minipage}\hfill
    \subsection{Kennzeichnung-Aluminium}
...
\includegraphics[height=0.5\linewidth]{img/gussverfahren_aluminium.png}
    ...
    \begin{minipage}[t]{0.32\columnwidth}
        ...
        \end{itemize} 
    \end{minipage}\hfill
    \begin{itemize}[label={}, leftmargin=*, itemsep=0pt, topsep=0pt, parsep=0pt]
        \item \textbf{Aluminium-Gusslegierung:}
        höhere Gehalte an Legierungselementen als Knetlegierungen
        (v.\,a.\ Si, Mg); eutektisch nahe 12\% Si;
        geringe Löslichkeit von Si in Al.
    \end{itemize}
...
\includegraphics[width=\linewidth]{img/titan_legierungen.png}
    \subsection{Klassifizierung von Titan}
...
\includegraphics[width=\linewidth]{img/klassifizierung_titan.png}
    \subsection{Eigenschaften von Titan}
    \includegraphics[width=\linewidth]{img/eigenschaften_von_titan.png}
    \subsection{Anwendungen von Titan}\mbox{}\\
    \begin{minipage}[t]{0.5\columnwidth}
        \begin{itemize}[label={}, leftmargin=*, itemsep=0.01em]
    ...
    Dichte 1.74 $\mathrm{\frac{g}{cm^3}}$, $T_m=650^\circ$C, hdp.\hfill
    \textbf{}E-Modul 45\,GPa, geringe Korrosionsbeständigkeit, exzellente Gießbarkeit.
    \subsection{Kennzeichnung Magnesium}
    \subsection{Verarbeitung von Magnesium}
    \begin{minipage}[t]{0.5\columnwidth}
        \begin{itemize}[label={}, leftmargin=*, itemsep=0.01em]
            \item \textbf{Gusslegierung}
...
\includegraphics[width=\linewidth]{img/ztu_diagramm.png}
    \begin{minipage}[t]{1\columnwidth}
        ...
        \end{itemize}
    \end{minipage}\hfill
    \subsection{Härtemethoden}\mbox{}\\
    \includegraphics[width=\linewidth]{img/härte_methoden.png}
    \subsection{Abkühlmedium}\mbox{}\\
    ...
    \end{minipage}\hfill
    \section{Polymere}
    \subsection{Synthese von Kunststoffen}\mbox{}\\
    \begin{minipage}[t]{0.32\columnwidth}
        \begin{itemize}[label={}, leftmargin=*, itemsep=0.01em]
    ...
    \begin{minipage}[t]{0.32\columnwidth}
        ...
        \end{itemize}
    \end{minipage}\hfill
    \subsection{Typen von Kunststoffen}\mbox{}\\
    \begin{itemize}[label={}, leftmargin=*,  itemsep=0.01em]
    ...
    \begin{minipage}[t]{0.32\columnwidth}
        \textbf{stabil}\\
        $\rightarrow$ niedrigste freie Energie\\
        $\rightarrow$ dauerhaft existent\\
        Bsp.: Ferrit + Zementit (RT)
    \end{minipage}\hfill
    \begin{minipage}[t]{0.32\columnwidth}
        \textbf{metastabil}\\
        $\rightarrow$ nicht energetisch minimal\\
        $\rightarrow$ stabil durch Barriere\\
        Bsp.: Martensit (RT)
    \end{minipage}\hfill
    \begin{minipage}[t]{0.32\columnwidth}
        \textbf{instabil}\\
        $\rightarrow$ kein Energieminimum\\
        $\rightarrow$ spontane Umwandlung\\
        $T_\text{Schmelze}<T_s$
    \end{minipage}
    \begin{minipage}[t]{0.32\columnwidth}
        \textbf{Haltepunkte}\\
        $\rightarrow$ Schmelzpunkt der reinen Komponenten\\
    \end{minipage}\hfill
    \begin{minipage}[t]{0.32\columnwidth}
        \textbf{Knickpunkte}\\
        $\rightarrow$ Start und Ende des Erstarrungbereiches der Legierung\\
    \end{minipage}\hfill
    \begin{minipage}[t]{0.32\columnwidth}
        \textbf{Zweistoffsystem}\\
        $\rightarrow$ im Zweiphasengebiet ändern sich nur die
        Mengenanteile, nicht die Zusammensetzung
    \end{minipage}
